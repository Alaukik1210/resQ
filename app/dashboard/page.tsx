          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-6">
             ...
             { session? <button
                ...
                className="px-4 py-2 text-sm font-medium text-neutral-300  cursor-pointer bg-neutral-900 rounded-lg hover:bg-neutral-800 border border-neutral-800 transition-all hover:border-neutral-700"
              >
                Sign out
              </button> :
              <button
